...
notebook.add(f6, text=' ')
f7 = ttk.Frame(notebook)
notebook.add(f7, text='RF PWR convert mW dBM')
...
btn111=tk.Button(f7, text='dBm to Watts & Volts', command=wv).grid(column=1, row=3)
btn333=tk.Button(f7, text='Millwatts to dBm', command=dbm).grid(column=1, row=5)
