...
root5 = tk.Tk()
root5.geometry("1500x800")
root5.title("Resistor Calc Series Parallel Voltage Divder")
# --- functions ---
...
tk.Label(root5, text=" Input R1:").grid(row=0, column=0)
tk.Label(root5, text="Input R2:").grid(row=1, column=0)
tk.Label(root5, text="Vin for Vdiv").grid(row=2, column=0)
num111 = tk.Entry(root5, bg="wheat")
num111.grid(row=0, column=1)
num222 = tk.Entry(root5, bg="wheat")
num222.grid(row=1, column=1)

vvv1 = tk.Entry(root5, bg="wheat")
vvv1.grid(row=2, column=1)
lb7 = tk.Listbox(root5, height=20)
lb7.grid(row=6,  column=2)
lb9 = tk.Listbox(root5, height=20)
lb9.grid(row=6,  column=1)
b1 = tk.Button(root5, text="Calculate", command=generate)
b1.grid(row=6, column=0)
b3 = tk.Button(root5, text="Clear", command=clearlist1)
b3.grid(row=7, column=0)

tk.Label(root5, text=" Input R1:").grid(row=0, column=4)
tk.Label(root5, text="Input R2:").grid(row=1, column=4)
tk.Label(root5, text="Input R3:").grid(row=2, column=4)
tk.Label(root5, text="Input R4").grid(row=3, column=4)
tk.Label(root5, text="Vin").grid(row=4, column=4)
num1234 = tk.Entry(root5, bg="wheat")
num1234.grid(row=0, column=5)
num4567 = tk.Entry(root5, bg="wheat")
num4567.grid(row=1, column=5)
num7891 = tk.Entry(root5, bg="wheat")
num7891.grid(row=2, column=5)
num1112 = tk.Entry(root5, bg="wheat")
num1112.grid(row=3, column=5)
vvv2 =tk.Entry(root5, bg="wheat")
vvv2.grid(row=4, column=5)
lb8 = tk.Listbox(root5, height=20)
lb8.grid(row=6, column=7)
lb10 = tk.Listbox(root5, height=20)
lb10.grid(row=6, column=6)
b2 = tk.Button(root5, text="Calculate 4 Resistor", command=gen2)
b2.grid(row=6, column=5)
b4 = tk.Button(root5, text="Clear", command=clearlist2)
