...
l = tk.Entry(root45, bg="yellow", font=("Arial", 14))
l.grid(row=1, column=2)
c1 = tk.Label(root45, text="Capcitance Value", font=("Arial", 14))
c1.grid(row=3, column=2)
c = tk.Entry(root45, bg="light blue", font=("Arial", 14))
...
calc_button = tk.Button(root45, text='Calculate>>', bg="orange", font=("Arial Black", 12), command = lambda: combo_calc(l.get(), c.get(), n.get(), n2.get()))
calc_button.grid(row=5, column=5)
lb5 = tk.Listbox(root45, width=40)
lb5.grid(row=16,  column=4)
lb6 = tk.Listbox(root45, width=40)
...
##    ttrl.grid(row=2, column=7)
    ...
    lb6.insert(1, "Hz")
    lb6.insert(2, "farads")
##    na2 = tk.Label(root45, text=na2, font=("Arial Black", 8))
##
